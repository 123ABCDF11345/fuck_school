...
class TestTime(object):
    ...
    def debug(self,event):
        ...
        self.buttonA=Button(self.w_debug,text='Close Display(BATE)',command=self.tryclose)
        self.buttonA.pack()
...
if __name__ == '__main__':
    ...
    message2.pack()
    threading.Timer(1, timetoclose, args=(message2,)).start()#定时器线程，5s后关闭防沉迷提示
    #倒计时类实例
    TestTime(root)
